...
Route::group(['prefix'=>'admin'],function(){
    Route::group(['prefix'=>'theloai'],function(){
        Route::get('danhsach', [App\Http\Controllers\TheLoaiController::class, 'getDanhSach'])->middleware('cacheResponse:600');
       // Route::get('danhsach/{id}', [App\Http\Controllers\TheLoaiController::class, 'getDanhSach'])->middleware('auth');
    ...
    Route::group(['prefix'=>'tintuc'],function(){
        ...
        Route::get('danhsach', [App\Http\Controllers\TinTucController::class, 'getDanhSach'])->middleware('auth');
