...
Route::group(['prefix'=>'admin'],function(){
    Route::group(['prefix'=>'theloai'],function(){
        ...
        Route::get('danh sach', [App\Http\Controllers\TheLoaiController::class, 'getDanhSach'])->middleware('auth');
    ...
    Route::group(['prefix'=>'loaitin'],function(){
        ...
        Route::get('them',[App\Http\Controllers\LoaiTinController::class, 'getThem'])->middleware('auth');
